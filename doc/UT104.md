...
Definiteness is primarily concerned with identifiability of the referent expressed with a noun phrase in the ongoing discourse. It is often expressed by lexical items (articles) but affixes also occur (Lyons 1999). One option is also to use possessive affixes, in which case they have a non-possessive meaning. This question asks whether 2Sg possessive suffixes can be used to mark definiteness (cf. also UT105), as in Forest Enets. 
