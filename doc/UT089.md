...
**Coding.** The answer is '1' if syncretism between goal and location marking characterises at least one set of cases (e.g., the expression of external, internal, or proximity relations). If syncretism is impossible/uncommon, the answer is '0'.  
