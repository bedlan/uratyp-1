**Are there non-finite forms that can relativize at least some non-core participants but cannot relativize all or some of the core participants?**

In addition to the types covered in questions UT055 and UT056, it is possible to find participles that can relativize some non-core participants (e.g., instrumentals, locatives) but not necessarily all or some core participants. For instance, in Beserman Udmurt there is a participle ending in *-n*, which can be used to relativize instrumentals and direct objects (P) (1a and 1b, respectively), but not subjects (S/A) (Shagal 2018: 74).
