**Can S and P be conflated morphologically across clause boundaries, i.e., act as a syntactic pivot?**

Apart from languages where S and A can be conflated across clause boundaries (cf. UT014) there are also languages that can combine S (= subject in an intransitive sentence) and P (= object in a transitive sentence), which implies an 'ergative' pivot (see Aikhenvald 2015:258). East Mansi (1) shows this possibility.
