...
**Coding.** The value is '1' only if there is a dedicated case marker. In order to suffice for a '1', such case marking has to be productive and not only occur with a limited set of words or in some fossilized forms. 
