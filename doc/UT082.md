...
To compare, in Estonian, the allative case (a local case) is used in both functions, e.g., *minu-le* (1SG-ALL) ‘to me’, *põranda-le* (floor-ALL) 'onto the floor'. Thus, Estonian is coded as ‘0’.
