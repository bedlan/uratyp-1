...
**Coding.** The value is '1' if there is at least one such non-finite form, which is specialized on the relativization of one of these arguments. If one participle can relativize S/A, P, and S/P, the answer is '0'. 
