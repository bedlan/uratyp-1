...
The frequentative is used to describe a situation (event or a state of affairs) as frequently repeating. The aim of this question is to find out whether frequentativity can be expressed by means other than lexical ones. Both in North Mansi (1) and Hungarian (2), a derivational suffix is used to convey frequentativity.
