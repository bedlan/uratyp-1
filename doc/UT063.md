...
Non-finite forms can be found in various functions. This question asks whether it is possible that one and the same form appears both as a participle and as action nominalization (see 1a and 1b, respectively).
...
For an overlap between the form functioning as a participle and as agentive nominalization, see UT064. 

**Coding.** The value is '1' if a non-finite form can be used both as a participle and as action nominalization without any additional morphology. 
