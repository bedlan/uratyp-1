...
In the case of a reflexive verb an agent can be viewed to perform an action directed at itself; they are often accompanied by reflexive pronouns (e.g., *dress oneself*). Here, we are interested whether a language contains a separate paradigm of verb affixes used to convey reflexivity, as in Veps (cf. 1a and 1b).
...
**Coding.** The value is '1' if reflexive conjugation is available in various persons and it differs from non-reflexive conjugation (as in Veps). If a language only contains a reflexive derivational suffix, the value is '0'. For example, in Meadow Mari the derivational suffix *-alt* precedes the personal suffixes and it does not vary throughout the paradigm (see Riese et al. 2022: 383). Thus, for Meadow Mari the value is '0'. 
