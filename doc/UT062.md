...
This question asks whether there are participles that obligatorily agree with the nouns they modify in case and number. This is possible, for instance, in Finnish (see 1). Here, all contexts is used to mean contexts where one would expect agreement also otherwise, e.g., in the case of adnominal modifiers (cf. example 2).
